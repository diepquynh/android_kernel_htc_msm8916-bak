...
typedef enum {
	VENUS_ENABLE_VIF_FRAME_START_INTERRUPT,
	VENUS_ENABLE_VIF_FRAME_END_INTERRUPT,
	
	VENUS_ENABLE_IBC_FRAME_START_INTERRUPT,
	VENUS_ENABLE_IBC_FRAME_END_INTERRUPT,
	
	VENUS_ENABLE_DSI_DATA_ASYNC_FIFO_UNDERRUN,
	VENUS_ENABLE_DSI_DATA_RT_OVERFLOW,
	
	VENUS_ENABLE_I2CM_SLAVE_NOACK_INTERRUPT,
	VENUS_ENABLE_I2CM_ADDR_WD_FIFO_FULL_INTERRUPT,
	VENUS_ENABLE_I2CM_RD_FIFO_FULL_INTERRUPT
...
uint8 VA_GetExposureTime(uint16 *N, uint16 *M);
