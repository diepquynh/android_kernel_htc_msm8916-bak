...
#define VENUS_SHAPRNESS_MANUAL								(0x5A)
#define VENUS_GAMMA_MANUAL									(0x5B)
#define VENUS_BRIGHTNESS_MANUAL								(0x5C)
#define VENUS_SATURATION_MANUAL								(0x5D)
...
#define VENUS_AEIF_SET_AE_ROI_LUMA_TARGET					(0xF1)
#define VENUS_AEIF_GET_AE_ROI_LUMA							(0xF2)
