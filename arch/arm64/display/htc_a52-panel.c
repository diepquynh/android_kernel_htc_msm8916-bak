...
static int htc_a52_regulator_init(struct platform_device *pdev)
{
	...
	pwrdata->lcmn5v = of_get_named_gpio(pdev->dev.of_node,
						"htc,lcm_n5v-gpio", 0);
	pwrdata->lcm_ldo_1v8_en = of_get_named_gpio(pdev->dev.of_node,
						"htc,lcm_ldo_1v8_en-gpio", 0);
...
void htc_a52_panel_reset(struct mdss_panel_data *pdata, int enable)
{
	struct mdss_dsi_ctrl_pdata *ctrl_pdata = NULL;
	struct dsi_power_data *pwrdata = NULL;
...
static struct mdss_dsi_pwrctrl dsi_pwrctrl = {
	.dsi_regulator_init = htc_a52_regulator_init,
	.dsi_regulator_deinit = htc_a52_regulator_deinit,
	.dsi_power_on = htc_a52_panel_power_on,
	.dsi_panel_reset = htc_a52_panel_reset,
